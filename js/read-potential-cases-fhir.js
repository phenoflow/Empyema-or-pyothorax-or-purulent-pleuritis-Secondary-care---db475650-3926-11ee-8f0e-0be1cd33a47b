...
(async () => {
  ...
  await fs.writeFile("empyema-or-pyothorax-or-purulent-pleuritis-secondary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("empyema-or-pyothorax-or-purulent-pleuritis-secondary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
